...
只参考其 PySide6 + QFluentWidgets 的桌面工具组织方式、深色 Fluent 风格、项目协作说明结构和技术债记录方式，不照搬 LaunchDock 的业务、图标、品牌素材或启动坞功能。
...
`development-log.md` 不只记录已经落地的代码或文档修改；当进入重要规划阶段、形成关键设计思路、确认技术路线、拆分里程碑、发现技术债或暂停在某个阶段时，也应记录当前进度和下一步。
