...
- 进入重要规划、桌面应用设计、技术路线确认或阶段性暂停时，也应同步更新 `development-log.md`，记录当前结论、待确认问题和下一步，方便新对话延续项目进度。
...
如果文档、开发记录或设计说明引用用户提供的参考项目、教程、工具或外部资料，应尽量保留完整 URL，而不只写项目名，方便新对话或其他智能体继续追溯上下文。
...
- README / AGENTS / Skill：
  ...
  - 检查用户提供的参考项目、教程、工具或外部资料是否保留完整 URL。
